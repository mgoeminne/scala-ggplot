 ...
 * @tparam T
 */
case class rect[T]( mapping: Option[(Seq[Numeric[T]], Seq[Numeric[T]])] = None,
                    data: Option[Frame[Any,Any,T]] = None,
                    stat: Statistic = rectUtil.defaultStat,
                    position: Position = rectUtil.defaultPos) extends Geom

private object rectUtil
{

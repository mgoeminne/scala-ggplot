 ...
 * @tparam T
 */
case class pointrange[T]( mapping: Option[(Seq[Numeric[T]], Seq[Numeric[T]])] = None,
                          data: Option[Frame[Any,Any,T]] = None,
                          stat: Statistic = pointrangeUtil.defaultStat,
                          position: Position = pointrangeUtil.defaultPos) extends Geom

private object pointrangeUtil
{
